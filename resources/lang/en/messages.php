...
return [
	...
	"shipping_cost_updated_successfully" => "Shipping cost updated successfully",
	"shipping_cost_deleted_successfully" => "Shipping cost deleted successfully",
	...
	"order_source_filter_tooltip" => "Filter by where the order came from (EasyOrders or POS). When set, this overrides the Order type filter for source.",
