                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="tel" name="phone" id="customer_phone" placeholder="{{ translate('enter_phone_number') }}" required data-no-intl="true" maxlength="11" pattern="(0(10|11|12|15)[0-9]{8}|0[2-9][0-9]{7,8})" title="{{ translate('egyptian_mobile_input_title') }}">
                                        </div>
                                    </div>
                                    <div class="col-12 col-lg-6">
                                        <div class="form-group">
                                            <label class="form-label mb-1">{{ translate('alternative_phone') }}</label>
                                            <input class="form-control" type="tel" name="alternative_phone" id="customer_alt_phone" placeholder="{{ translate('enter_phone_number') }}" data-no-intl="true" maxlength="11" pattern="(0(10|11|12|15)[0-9]{8}|0[2-9][0-9]{7,8})" title="{{ translate('egyptian_mobile_input_title') }}">
                                        </div>
                                    </div>
                                    <div class="col-12 col-lg-6">
                                        <div class="form-group">
