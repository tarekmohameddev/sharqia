...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['admin', 'actch:admin_panel']], function () {
    ...
    Route::group(['prefix' => 'pos', 'as' => 'pos.', 'middleware' => ['module:pos_management']], function () {
        Route::controller(POSController::class)->group(function () {
            ...
            Route::get('product-list', 'getProductListView')->name('product-list');
    ...
    Route::group(['prefix' => 'authenticity', 'as' => 'authenticity.'], function () {
        ...
        Route::group(['prefix' => 'batches', 'as' => 'batches.'], function () {
            ...
            Route::controller(AuthenticityBatchExportController::class)->group(function () {
                ...
                Route::get('{id}/export-pdf-single', 'exportPdfSingle')->name('export-pdf-single');
                Route::get('{id}/export-zip', 'exportZip')->name('export-zip');
